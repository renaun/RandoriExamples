...
package com.hsharma.hungryHero.ui
{
	...
	public class GameOverContainer extends Sprite
	{
		...
		private function drawGameOver():void
		{
			...
			// Navigation buttons.
			mainBtn = new Button(AssetsHungryHero.getAtlas().getTexture("gameOver_mainButton"));
			mainBtn.y = (stage.stageHeight * 70)/100;
			mainBtn.addEventListener(Event.TRIGGERED, onMainClick);
			this.addChild(mainBtn);
			
			playAgainBtn = new Button(AssetsHungryHero.getAtlas().getTexture("gameOver_playAgainButton"));
			...
			aboutBtn = new Button(AssetsHungryHero.getAtlas().getTexture("gameOver_aboutButton"));
