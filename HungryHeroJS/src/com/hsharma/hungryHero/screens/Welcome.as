...
package com.hsharma.hungryHero.screens
{
	...
	import com.hsharma.hungryHero.AssetsHungryHero;
	...
	public class Welcome extends Sprite
	{
		...
		private function drawScreen():void
		{
			...
			bg = new Image(AssetsHungryHero.getTexture("BgWelcome"));
			bg.blendMode = BlendMode.NONE;
			this.addChild(bg);
			
			title = new Image(AssetsHungryHero.getAtlas().getTexture(("welcome_title")));
			title.x = 600;
			title.y = 65;
			this.addChild(title);
			...
			hero = new Image(AssetsHungryHero.getAtlas().getTexture("welcome_hero"));
			hero.x = -hero.width;
			hero.y = 130;
			this.addChild(hero);
			
			playBtn = new Button(AssetsHungryHero.getAtlas().getTexture("welcome_playButton"));
			playBtn.x = 640;
			playBtn.y = 340;
			playBtn.addEventListener(Event.TRIGGERED, onPlayClick);
			this.addChild(playBtn);
			
			aboutBtn = new Button(AssetsHungryHero.getAtlas().getTexture("welcome_aboutButton"));
			aboutBtn.x = 460;
			aboutBtn.y = 460;
			...
			hsharmaBtn = new Button(AssetsHungryHero.getAtlas().getTexture("about_hsharmaLogo"));
			...
			starlingBtn = new Button(AssetsHungryHero.getAtlas().getTexture("about_starlingLogo"));
			...
			backBtn = new Button(AssetsHungryHero.getAtlas().getTexture("about_backButton"));
			backBtn.x = 660;
			backBtn.y = 350;
