...
import com.mrdoob.three.lights.AmbientLight;
import com.mrdoob.three.lights.DirectionalLight;
import com.mrdoob.three.loaders.ImageUtils;
import com.mrdoob.three.materials.MeshBasicMaterial;
import com.mrdoob.three.materials.MeshLambertMaterial;
...
public class CreateTextTexture
{	
	...
	{		
		...
		var textWidth:int = context.measureText(text).width;
		...
		context.fillRect(canvas.width / 2 - textWidth / 2 - padding / 2, canvas.height / 2 - size / 2 - padding / 2, textWidth + padding, size + padding);
		context.textAlign = "center";
		context.textBaseline = "middle";
		context.fillStyle = "blue";
		context.fillText(text, canvas.width / 2, canvas.height / 2);
		
		var texture:Texture = new Texture(canvas, null, NaN, NaN, NaN, NaN, NaN, NaN, NaN);
		...
		var ambientLight:AmbientLight = new AmbientLight(0xbbbbbb);
		scene.add(ambientLight);
		
		// directional lighting
		var directionalLight:DirectionalLight = new DirectionalLight(0xffffff, 1);
