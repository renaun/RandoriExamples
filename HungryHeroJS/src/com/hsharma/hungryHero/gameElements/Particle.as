		...
		public function Particle(_type:int)
		{
			...
			switch(_type)
			{
				case GameConstants.PARTICLE_TYPE_1:
					particleImage = new Image(AssetsHungryHero.getAtlas().getTexture("particleEat"));
					break;
				case GameConstants.PARTICLE_TYPE_2:
					particleImage = new Image(AssetsHungryHero.getAtlas().getTexture("particleWindForce"));
					break;
			}
