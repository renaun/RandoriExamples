...
package com.hsharma.hungryHero.gameElements
{
	...
	public class BgLayer extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			if (_layer == 1)
			{
				image1 = new Image(AssetsHungryHero.getTexture("BgLayer" + _layer));
				image1.blendMode = BlendMode.NONE;
				image2 = new Image(AssetsHungryHero.getTexture("BgLayer" + _layer));
				image2.blendMode = BlendMode.NONE;
			}
			else
			{
				image1 = new Image(AssetsHungryHero.getAtlas().getTexture("bgLayer" + _layer));
				image2 = new Image(AssetsHungryHero.getAtlas().getTexture("bgLayer" + _layer));
			}
