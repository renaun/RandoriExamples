...
package com.hsharma.hungryHero.ui
{
	...
	public class SoundButton extends Button
	{
		...
		{
			super(Texture.fromBitmapData(new BitmapData(AssetsHungryHero.getAtlas().getTexture("soundOff").width, AssetsHungryHero.getAtlas().getTexture("soundOff").height, true, 0)));
		...
		{
			// Normal state - image
			mcUnmuteState = new MovieClip(AssetsHungryHero.getAtlas().getTextures("soundOn"), 3);
			Starling.juggler.add(mcUnmuteState);
			this.addChild(mcUnmuteState);
			
			// Selected state - animation
			imageMuteState = new Image(AssetsHungryHero.getAtlas().getTexture("soundOff"));
